...
def parse_arguments() -> argparse.Namespace:
    ...
    parser.add_argument("comanda_file", type=str, help="File containing the 'comanda' to be processed")
...
async def main():
    ...
    for pedido in comanda_data.pedidos:
        print(f"{pedido.quantidade}x {pedido.nome_prato} - R$ {pedido.preco_unitario:.2f}")
    ...
    await build_and_save_message(comanda_data, api_key, "msg.txt")
